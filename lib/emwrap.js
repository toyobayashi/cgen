...
`
  ...
  const post = `
    return {
      ...
      IDBFS: typeof IDBFS !== 'undefined' ? IDBFS : undefined,
      WORKERFS: typeof WORKERFS !== 'undefined' ? WORKERFS : undefined,
      PROXYFS: typeof PROXYFS !== 'undefined' ? PROXYFS : undefined
    };
  }
  ...
  return (function (onExports) {
    ...
    function init (mod) {
      ...
      var p = promise = new Promise(function (resolve, reject) {
        ...
        var ret = __cgen_emwrapper__(mod);
        initResult.FS = ret.FS;
        initResult.NODEFS = ret.NODEFS;
        initResult.IDBFS = ret.IDBFS;
        initResult.WORKERFS = ret.WORKERFS;
        initResult.PROXYFS = ret.PROXYFS;
      }).catch(function (err) {
